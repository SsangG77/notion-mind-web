...
- 배치 값: FA2 gravity 0.05 · scalingRatio 40 · 4초 · 엣지 힘 = 양끝 평균 차수 기반 차등(허브 주변 넓게, 한적한 곳 가깝게). 이후 엣지 중앙값 420px 정규화 + 사각형 분리(여백 300/180px). 주의: FA2 워커는 kill 후 ~120ms 기다린 뒤 좌표를 만져야 함(늦게 도착한 워커 업데이트가 덮어씀)
